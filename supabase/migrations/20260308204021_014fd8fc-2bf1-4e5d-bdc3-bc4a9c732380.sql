...
-- Update notify_on_new_assignment to only notify students (not admins, school_admins, parents, tutors)
...
-- Update notify_on_new_quiz to only notify students
...
-- Update notify_on_new_module to only notify students
...
-- Update notify_on_new_lesson to only notify students
...
-- Update notify_on_new_announcement to only notify students
...
-- Update notify_on_grade to also notify parent if linked
